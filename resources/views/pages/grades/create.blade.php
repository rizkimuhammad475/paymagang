...
@include('partials.notif')
                      ...
                      <form class="form-horizontal style-form" method="post" action="{{ url('admin/manage/film/store') }}" enctype="multipart/form-data">
                      	{{ csrf_field() }} 
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Film Image</label>
                              <div class="col-sm-10">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <select name="category_id[]" class="form-control selectpicker" multiple id="done" data-done-button="true">
