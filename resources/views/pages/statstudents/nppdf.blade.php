				...
				<table class="col-md-12">
					<thead>
						<tr>
							...
							<th class="text-center col-md-2" style="padding: 0px;">GENDER</th>
							<th class="text-center col-md-2" style="padding: 0px;">PAY</th>
						</tr>
					</thead>
					<tbody>
						@foreach( $data['students'] as $index => $student )
						<tr>
							<td class="text-center col-md-2" style="padding: 0px;">{{ $student->nis }}</td>
							<td class="text-center col-md-6">{{ $student->name }}</td>
							<td class="text-center col-md-2" style="padding: 0px;">{{ $student->gender }}</td>
							<td class="text-center col-md-2" style="padding: 0px;">{{ $student->total }}</td>
						</tr>
						@endforeach
					</tbody>
				</table>
